      ...
      <div className="gap-16 lg:flex">
        <main className="w-full flex-shrink-0 flex-grow xl:max-w-[900px]">
          ...
          <Section id="choosing-paymaster">
            ...
            <P>
              We recommend the <A href="https://login.coinbase.com">Coinbase Developer Platform</A> paymaster. You can find a full list of
              ERC-7677-compliant paymaster services <A href="https://www.erc7677.xyz/ecosystem/paymasters">here</A>.
            </P>
            <P>
          ...
          <Section id="setting-proxy">
            ...
            <P>
              ...
              but highly recommended to be safe. See "Trust and Validation" <A href="https://hackmd.io/@AhweV9sISeevhvrtVPCGDw/BynRsX7Ca#Trust-and-Validation">here</A> for more on this.
              The code below is built specifically for Smart Wallets; it would need to be updated to
              support other smart accounts.
            </P>
